            ...
            <div class="col-md-10 column-center no-padding res-width-full">
                <div class="col-md-6 col-sm-6 col-xs-6 common-full features-res-bottom">
                    <div class="features-icon-left">
                        <img src="{{asset('images/2Frontend/64x64x5.jpg')}}" alt="image" />
                    </div>
                    <div class="features-pad-left features-bottom">
                        <h4 class="left h4-bottom"><a href="#">Competitive Rate</a></h4>
                        <p class="left">247 Airport Express ensures the best rate for your selected route. We are also the most competitive rate airport shuttle service in Cambridge. </p>
                    </div>

                    <div class=" center features-icon-left">
                        <img src="{{asset('images/2Frontend/64x64x6.jpg')}}" alt="image" />
                    </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-6 common-full">
                    <div class="features-icon-left">
                        <img src="{{asset('images/2Frontend/64x64x7.jpg')}}" alt="image" />
                    </div>
                    <div class="features-pad-left features-bottom">
                    ...
                    <!-- <div class="features-icon-left">
                        <img src="{{asset('images/2Frontend/64x64x8.jpg')}}" alt="image" />
                    </div>
                    <div class="features-pad-left features-bottom">
