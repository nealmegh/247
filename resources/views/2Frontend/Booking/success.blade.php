...
{{--    <div id="" class="booking-form col-12" style="margin-top: 160px;" >--}}
                    ...
                    <div id="jumbotronBasic" class="col-xl-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="jumbotron">
                                        <h2 class="display-4 mb-5  mt-4 text-center text-info" style="font-family: 'Quicksand'; margin-bottom: 10px!important;">Payment Confirmation</h2>
                                            ...
                                            <div class="widget-content">
                                                ...
                                                <div class="invoice-list">
                                                    ...
                                                    <div class="inv-action" style="margin-bottom: 10px!important;">
                                                        <h4 class="text-success"  style="font-family: 'Quicksand';">Thank you for your payment</h4>
                                                    </div>
                                                    <div class="inv-action">
                                                        <a href="{{route('customer.dashboard')}}" class="btn btn-outline-primary view-details">View Dashboard</a>
                                                        <a href="javascript:void(0);" class="btn btn-outline-primary pay-now">Paid £{{number_format((float)$booking->final_price, 2, '.', '')}}</a>
                                                    </div>
                                                </div>
                                            </div>
