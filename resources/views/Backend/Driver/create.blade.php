                    ...
                    <div class="widget-content widget-content-area">
                        <form class="form-horizontal form-label-left" novalidate method="POST" action="{{ route('driver.store') }}">
                            ...
                            <div class="form-row mb-4">
                                ...
                                <input id="first_name" value="{{old('first_name')}}" class="form-control" data-validate-length-range="6" data-validate-words="2" name="first_name" placeholder="Enter Forename" required="required" type="text">
                            </div>

                            <div class="form-row mb-4">
                                <label class="control-label"  for="last_name">Last Name <span class="required">*</span>
                                </label>
                                <input id="last_name" value="{{old('last_name')}}" class="form-control" data-validate-length-range="6" data-validate-words="2" name="last_name" placeholder="Enter Surname" required="required" type="text">
                            </div>
                            <div class="form-row mb-4">
                                <label class="control-label"  for="email">Email <span class="required">*</span>
                                </label>
                                <input type="email" id="email" value="{{old('email')}}" name="email" placeholder="Email Address" required="required" class="form-control">
                            </div>
                            <div class="form-row mb-4">
                                <label class="control-label"  for="phone">Phone <span class="required">*</span>
                                </label>
                                <input type="text" id="phone" value="{{old('phone')}}" name="phone_number" placeholder="Enter Driver's Phone Number" required="required"  class="form-control">
                            </div>
                            <div class="form-row mb-4">
                                <label class="control-label" for="dlva_eccc">DVLA ECCC<span class="required">*</span>
                                </label>
                                <input value="{{old('dlva_eccc')}}" type="text" id="dlva_eccc" name="dlva_eccc" required="required"  class="form-control">
                            </div>
                            <div class="form-row mb-4">
                                <label class="control-label" for="private_hire_license">Private Hire License Number <span class="required">*</span>
                                </label>
                                <input type="text" value="{{old('private_hire_license')}}" id="private_hire_license" name="private_hire_license" placeholder="Enter Private Hire License Number" required="required"  class="form-control">
                            </div>
                            <div class="form-row mb-4">
                                <label for="private_hire_license_date">Expiry of Private Hire License Number <span class="required">*</span></label>
                                <input type="text" class="form-control" value="{{old('private_hire_license_date')}}" id="private_hire_license_date" {{old('private_hire_license_date')}} name="private_hire_license_date" placeholder="Expire Date" required="required">
                            </div>
                            <div class="form-row mb-4">
                            ...
                            <div class="form-row mb-4">
                                ...
                                <input type="text" class="form-control" value="{{old('driving_license')}}" id="driving_license" {{old('driving_license')}} name="driving_license" placeholder="License Number" required="required">
                            </div>
                            <div class="form-row mb-4">
                                <label for="driving_license_date">Expiry of Driver's License Number <span class="required">*</span></label>
                                <input type="text" class="form-control" value="{{old('driving_license_date')}}" id="driving_license_date" {{old('driving_license_date')}} name="driving_license_date" placeholder="Expire Date" required="required">
                            </div>
                            <div class="form-row mb-4">
                            ...
                            <div class="form-row mb-4">
                                ...
                                <input type="text" class="form-control" value="{{old('insurance_date')}}" id="insurance_date" {{old('insurance_date')}} name="insurance_date" placeholder="Expire Date" required="required">
                            </div>
                            <div class="form-row mb-4">
                            ...
                            <div class="form-row mb-4">
                                ...
                                <input value="{{old('vehicle_reg')}}" type="text" id="vehicle_reg" name="vehicle_reg" placeholder="Enter Vehicle Registration Number" required="required"  class="form-control">
                            </div>
                            <div class="form-row mb-4">
                                <label class="control-label" for="vehicle_make">Vehicle Make <span class="required">*</span>
                                </label>
                                <input type="text" value="{{old('vehicle_make')}}" id="vehicle_make" name="vehicle_make" placeholder="Enter Vehicle Make Number" required="required"  class="form-control">
                            </div>
                            <div class="form-row mb-4">
                                <label class="control-label" for="vehicle_license">Vehicle license Number <span class="required">*</span>
                                </label>
                                <input type="text" value="{{old('vehicle_license')}}" id="vehicle_license" name="vehicle_license" placeholder="Enter Vehicle License Number" required="required"  class="form-control">
                            </div>
                            <div class="form-row mb-4">
                                <label for="private_hire_vehicle_license_date">Expiry of Private Hire Vehicle License Number <span class="required">*</span></label>
                                <input type="text" class="form-control" value="{{old('private_hire_vehicle_license_date')}}" id="private_hire_vehicle_license_date" {{old('private_hire_vehicle_license_date')}} name="private_hire_vehicle_license_date" placeholder="Expire Date" required="required">
                            </div>
                            <div class="form-row mb-4">
                            ...
                            <div class="form-row mb-4">
                                ...
                                <input value="{{old('commission')}}" type="text" id="commission" name="commission" placeholder="Enter Driver's Commission" required="required"  class="form-control">
                            </div>
